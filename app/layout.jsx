...
export const metadata = {
  ...
  description:
    'فینوجا یک وب‌اپلیکیشن تعاملی آموزش مالی است که با بازی‌وارسازی، یادگیری اصول مالی، مدیریت هزینه و سرمایه‌گذاری را برای همه آسان و جذاب می‌کند. همین حالا شروع کنید، مدرک معتبر بگیرید و آماده ورود به بازار کار شوید!',
